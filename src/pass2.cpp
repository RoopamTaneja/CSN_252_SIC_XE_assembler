...
void pass2()
{
  ...
  if (!objectFile)
  {
    cout << "Unable to open file: object_" << fileName << "\n";
    exit(1);
  }
  ...
  if (!ListingFile)
  {
    cout << "Unable to open file: listing_" << fileName << "\n";
    exit(1);
  }
...
int main()
{
  ...
  cout << "\nPerforming Pass 1\n";
  cout << "Writing the Intermediate File to 'intermediate_" << fileName << "'\n";
  cout << "Writing the Error File to 'error_" << fileName << "'\n";
  pass1();

  cout << "Making the Symbol Table\n";
  ...
  writeToFile(printtab, writestring);
  cout << "\nPerforming Pass 2\n";
  cout << "Writing the Object File to 'object_" << fileName << "'\n";
  cout << "Writing the Listing File to 'listing_" << fileName << "'\n";
  pass2();
}
